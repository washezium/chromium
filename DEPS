...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ed67d6530f6bd1058c01d0924a31dbf4d4b97dd5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/requests/src': {
      'url': Var('chromium_git') + '/external/github.com/kennethreitz/requests.git' + '@' + 'b7c6aba848b10933f327fcce41970c29dc59051b',
      'condition': 'checkout_android',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@880b9033b954ff9e388fb153ba477e5394576d11',

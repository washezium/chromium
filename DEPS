vars = {
  ...
  'angle_revision':
    '8d986bf24128b2eb05b1e14dfdea42d05225ccd1',
  'aomedia_git':
  ...
  'catapult_revision':
    '6a7c1ed24c1a750c1dc34546e00b7d83f261df72',
  ...
  'pdfium_revision':
    '9b746fdef766c2cfbd7a54fb43406cf72f9685bf',
  'sfntly_revision':
    '16f3404e41edc9708a51fbce481f22e46b809686',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    'bd8b25a7b4c20d7a612fbb6af9586ec994609202',
  'swarming_revision':
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@8d986bf24128b2eb05b1e14dfdea42d05225ccd1',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@6a7c1ed24c1a750c1dc34546e00b7d83f261df72',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@9b746fdef766c2cfbd7a54fb43406cf72f9685bf',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@bd8b25a7b4c20d7a612fbb6af9586ec994609202',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@fc8d26bd8ad627a4469bbe2ca6e343ae9fe4e537',
